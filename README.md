...
<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&weight=600&size=22&duration=3000&pause=1200&color=00C2A8&center=true&vCenter=true&width=650&lines=I+am+a+website+pentester;Aspiring+Cloud+Security+Engineer+%26+Cloud+Pentester" alt="Typing SVG" />

</div>

<div align="center">

<!-- ⚠️ Links already daal di hain jo aapne bheji thin -->
<a href="https://tryhackme.com/p/0xaky" target="_blank">
  <img src="https://img.shields.io/badge/TryHackMe-212C42?style=for-the-badge&logo=tryhackme&logoColor=red" alt="TryHackMe"/>
</a>
<a href="https://www.linkedin.com/in/0xaky/" target="_blank">
...
<a href="https://bugcrowd.com/h/0xaky" target="_blank">
  <img src="https://img.shields.io/badge/Bugcrowd-FF6135?style=for-the-badge&logo=bugcrowd&logoColor=white" alt="Bugcrowd"/>
</a>
...
<!-- ⚠️ IMPORTANT: In pin cards ke liye YOUR-GITHUB-USERNAME ko apne
     asli GitHub username se replace karna hai (jaise 0xnerd1 ya jo bhi ho).
     Neeche 2 repo names woh hain jo aapki screenshot me nazar aa rahe thay.
     Baaki 2 (REPO-NAME-3, REPO-NAME-4) apne asli 2 repos ke naam se replace kar dena. -->
...
<!-- ⚠️ Yahan bhi YOUR-GITHUB-USERNAME replace karni hai -->
...
<!--
  ⚠️ GitHub README ke andar real "upload button" ya JS slideshow
  kaam nahi karta (GitHub sirf static Markdown + images allow karta hai,
  koi script chalne nahi deta). Iska sabse acha practical tareeqa yeh hai:

  1. Apni repo me "assets/certificates" naam ka folder bana lein.
  2. Har certificate ka screenshot/PNG usme daal dein
     (e.g. assets/certificates/cert1.png, cert2.png, waghera).
  3. Neeche table me jitni chahen utni rows/columns bana ke image path
     daal dein — yeh grid dekhne me slideshow/gallery jaisa hi lagta hai.

  Naya certificate add karna ho to bas ek naya <td><img ...></td> add kar dein.
-->
...
<table>
  <tr>
    <td align="center"><img src="./assets/certificates/cert1.png" width="260"/></td>
...
<div align="center">
  <sub>Built with 🖤 by Aiman Salman</sub>
</div>
